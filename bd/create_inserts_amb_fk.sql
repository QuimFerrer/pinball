...
CREATE TABLE IF NOT EXISTS `u555588791_pinba`.`admin` (
  ...
  INDEX `fk_admin_usuari1_idx` (`_01_pk_idAdm` ASC),
...
CREATE TABLE IF NOT EXISTS `u555588791_pinba`.`jugador` (
  ...
  INDEX `fk_jugador_usuari_idx` (`_01_pk_idJug` ASC),
...
CREATE TABLE IF NOT EXISTS `u555588791_pinba`.`inscrit` (
  ...
  INDEX `fk_torneig_has_jugador_torneig1_idx` (`_01_pk_idTornInsc` ASC, `_02_pk_idJocInsc` ASC),
...
CREATE TABLE IF NOT EXISTS `u555588791_pinba`.`maqInstall` (
  ...
  INDEX `fk_maquina_has_juego_maquina1_idx` (`_01_pk_idMaqInst` ASC),
...
CREATE TABLE IF NOT EXISTS `u555588791_pinba`.`ubicacioTeMaquina` (
  ...
  INDEX `fk_ubicacio_has_maquina1_ubicacio1_idx` (`_01_pk_idUbicUTM` ASC),
...
-- -----------------------------------------------------
-- Table `u555588791_pinba`.`configuracio`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `u555588791_pinba`.`configuracio` ;

CREATE TABLE IF NOT EXISTS `u555588791_pinba`.`configuracio` (
  `_01_pk_idConfig` INT NOT NULL,
  `_02_nomServerMYSQL` VARCHAR(30) NOT NULL,
  `_03_usrMYSQL` VARCHAR(30) NOT NULL DEFAULT '',
  `_04_passwordUsrMYSQL` VARCHAR(30) NULL,
  `_05_dbLocalOrRemot` VARCHAR(5) NOT NULL,
  `_06_emailDebug` INT NULL,
  `_07_emailSMTPHost` VARCHAR(40) NULL,
  `_08_emailSMTPHostPort` VARCHAR(6) NULL,
  `_09_emailUser` VARCHAR(40) NULL,
  `_10_emailPassword` VARCHAR(40) NULL,
  `_11_emailFrom` VARCHAR(40) NULL,
  `_12_emailNomFrom` VARCHAR(40) NULL,
  `_13_emailNomToContacte` VARCHAR(40) NULL,
  `_14_emailCanal` INT NULL,
  `_15_emailPathRegistre` VARCHAR(40) NULL,
  `_16_pathUploads` VARCHAR(40) NULL,
  `_17_sizeUploads` FLOAT NULL,
  `_18_datModConfig` DATETIME NULL,
  PRIMARY KEY (`_01_pk_idConfig`))
ENGINE = InnoDB;
...
START TRANSACTION;
USE `u555588791_pinba`;
INSERT INTO `u555588791_pinba`.`usuari` (`_01_pk_idUsuari`, `_02_nomUsuari`, `_03_cognomUsuari`, `_04_loginUsuari`, `_05_pwdUsuari`, `_06_emailUsuari`, `_07_fotoUsuari`, `_08_datAltaUsuari`, `_09_datModUsuari`, `_10_datBaixaUsuari`, `_11_activacioUsuari`, `_12_estatUsuari`) VALUES (2, 'joan', 'salas', 'joan', 'joan', 'jsalas@gmail.com', 'foto2.jpg', '2014-05-13', NULL, NULL, '1', 0);
INSERT INTO `u555588791_pinba`.`usuari` (`_01_pk_idUsuari`, `_02_nomUsuari`, `_03_cognomUsuari`, `_04_loginUsuari`, `_05_pwdUsuari`, `_06_emailUsuari`, `_07_fotoUsuari`, `_08_datAltaUsuari`, `_09_datModUsuari`, `_10_datBaixaUsuari`, `_11_activacioUsuari`, `_12_estatUsuari`) VALUES (3, 'josep', 'puig', 'josep', 'josep', 'jpuig@gmail.com', 'foto3.jpg', '2014-05-13', NULL, NULL, '1', 0);
INSERT INTO `u555588791_pinba`.`usuari` (`_01_pk_idUsuari`, `_02_nomUsuari`, `_03_cognomUsuari`, `_04_loginUsuari`, `_05_pwdUsuari`, `_06_emailUsuari`, `_07_fotoUsuari`, `_08_datAltaUsuari`, `_09_datModUsuari`, `_10_datBaixaUsuari`, `_11_activacioUsuari`, `_12_estatUsuari`) VALUES (4, 'miquel', 'roca', 'miquel', 'miquel', 'mroca@gmail.com', 'foto4.jpg', '2014-05-13', NULL, NULL, '1', 0);
INSERT INTO `u555588791_pinba`.`usuari` (`_01_pk_idUsuari`, `_02_nomUsuari`, `_03_cognomUsuari`, `_04_loginUsuari`, `_05_pwdUsuari`, `_06_emailUsuari`, `_07_fotoUsuari`, `_08_datAltaUsuari`, `_09_datModUsuari`, `_10_datBaixaUsuari`, `_11_activacioUsuari`, `_12_estatUsuari`) VALUES (5, 'rob', 'lopez', 'rob', 'rob', 'rob@gmail.com', 'foto5.jpg', '2014-05-13', NULL, NULL, '1', 0);
INSERT INTO `u555588791_pinba`.`usuari` (`_01_pk_idUsuari`, `_02_nomUsuari`, `_03_cognomUsuari`, `_04_loginUsuari`, `_05_pwdUsuari`, `_06_emailUsuari`, `_07_fotoUsuari`, `_08_datAltaUsuari`, `_09_datModUsuari`, `_10_datBaixaUsuari`, `_11_activacioUsuari`, `_12_estatUsuari`) VALUES (1, 'admin', 'admin', 'admin', 'admin', 'admadm@gmail.com', 'foto1.jpg', '2014-06-15', NULL, NULL, '1', 0);
...
START TRANSACTION;
USE `u555588791_pinba`;
INSERT INTO `u555588791_pinba`.`admin` (`_00_pk_idAdm_auto`, `_01_pk_idAdm`, `_02_faceAdm`, `_03_twitterAdm`, `_04_datAltaAdm`, `_05_datModAdm`, `_06_datBaixaAdm`) VALUES (1, 1, 'face1', 'twitter1', '2014-05-13', NULL, NULL);
...
START TRANSACTION;
USE `u555588791_pinba`;
INSERT INTO `u555588791_pinba`.`jugador` (`_00_pk_idJug_auto`, `_01_pk_idJug`, `_02_faceJug`, `_03_twitterJug`, `_04_datAltaJug`, `_05_datModJug`, `_06_datBaixaJug`) VALUES (1, 2, 'face2', 'twitter2', '2014-05-13', NULL, NULL);
INSERT INTO `u555588791_pinba`.`jugador` (`_00_pk_idJug_auto`, `_01_pk_idJug`, `_02_faceJug`, `_03_twitterJug`, `_04_datAltaJug`, `_05_datModJug`, `_06_datBaixaJug`) VALUES (2, 3, 'face3', 'twitter3', '2014-05-13', NULL, NULL);
INSERT INTO `u555588791_pinba`.`jugador` (`_00_pk_idJug_auto`, `_01_pk_idJug`, `_02_faceJug`, `_03_twitterJug`, `_04_datAltaJug`, `_05_datModJug`, `_06_datBaixaJug`) VALUES (3, 4, 'face4', 'twitter4', '2014-05-13', NULL, NULL);
INSERT INTO `u555588791_pinba`.`jugador` (`_00_pk_idJug_auto`, `_01_pk_idJug`, `_02_faceJug`, `_03_twitterJug`, `_04_datAltaJug`, `_05_datModJug`, `_06_datBaixaJug`) VALUES (4, 5, 'face5', 'twitter5', '2014-06-15', NULL, NULL);
...
START TRANSACTION;
USE `u555588791_pinba`;
INSERT INTO `u555588791_pinba`.`maqInstall` (`_00_pk_idMaqInst_auto`, `_01_pk_idMaqInst`, `_02_pk_idJocInst`, `_03_numPartidesJugadesMaqInst`, `_04_credJocMaqInst`, `_05_totCredJocMaqInst`, `_06_datAltaMaqInst`, `_07_datModMaqInst`, `_08_datBaixaMaqInst`) VALUES (1, 10, 100, 1, 100, 300, '2014-06-16 10:10:11', NULL, NULL);
INSERT INTO `u555588791_pinba`.`maqInstall` (`_00_pk_idMaqInst_auto`, `_01_pk_idMaqInst`, `_02_pk_idJocInst`, `_03_numPartidesJugadesMaqInst`, `_04_credJocMaqInst`, `_05_totCredJocMaqInst`, `_06_datAltaMaqInst`, `_07_datModMaqInst`, `_08_datBaixaMaqInst`) VALUES (2, 10, 101, 2, 100, 800, '2014-06-16 10:10:11', NULL, NULL);
INSERT INTO `u555588791_pinba`.`maqInstall` (`_00_pk_idMaqInst_auto`, `_01_pk_idMaqInst`, `_02_pk_idJocInst`, `_03_numPartidesJugadesMaqInst`, `_04_credJocMaqInst`, `_05_totCredJocMaqInst`, `_06_datAltaMaqInst`, `_07_datModMaqInst`, `_08_datBaixaMaqInst`) VALUES (3, 10, 102, 0, 100, 100, '2014-06-16 10:10:11', NULL, NULL);
INSERT INTO `u555588791_pinba`.`maqInstall` (`_00_pk_idMaqInst_auto`, `_01_pk_idMaqInst`, `_02_pk_idJocInst`, `_03_numPartidesJugadesMaqInst`, `_04_credJocMaqInst`, `_05_totCredJocMaqInst`, `_06_datAltaMaqInst`, `_07_datModMaqInst`, `_08_datBaixaMaqInst`) VALUES (4, 20, 102, 0, 200, 400, '2014-06-16 10:10:11', NULL, NULL);
INSERT INTO `u555588791_pinba`.`maqInstall` (`_00_pk_idMaqInst_auto`, `_01_pk_idMaqInst`, `_02_pk_idJocInst`, `_03_numPartidesJugadesMaqInst`, `_04_credJocMaqInst`, `_05_totCredJocMaqInst`, `_06_datAltaMaqInst`, `_07_datModMaqInst`, `_08_datBaixaMaqInst`) VALUES (5, 20, 103, 0, 200, 900, '2014-06-16 10:10:11', NULL, NULL);
INSERT INTO `u555588791_pinba`.`maqInstall` (`_00_pk_idMaqInst_auto`, `_01_pk_idMaqInst`, `_02_pk_idJocInst`, `_03_numPartidesJugadesMaqInst`, `_04_credJocMaqInst`, `_05_totCredJocMaqInst`, `_06_datAltaMaqInst`, `_07_datModMaqInst`, `_08_datBaixaMaqInst`) VALUES (6, 20, 104, 0, 200, 200, '2014-06-16 10:10:11', NULL, NULL);
INSERT INTO `u555588791_pinba`.`maqInstall` (`_00_pk_idMaqInst_auto`, `_01_pk_idMaqInst`, `_02_pk_idJocInst`, `_03_numPartidesJugadesMaqInst`, `_04_credJocMaqInst`, `_05_totCredJocMaqInst`, `_06_datAltaMaqInst`, `_07_datModMaqInst`, `_08_datBaixaMaqInst`) VALUES (7, 30, 101, 6, 1000, 8200, '2014-06-16 10:10:11', NULL, NULL);
INSERT INTO `u555588791_pinba`.`maqInstall` (`_00_pk_idMaqInst_auto`, `_01_pk_idMaqInst`, `_02_pk_idJocInst`, `_03_numPartidesJugadesMaqInst`, `_04_credJocMaqInst`, `_05_totCredJocMaqInst`, `_06_datAltaMaqInst`, `_07_datModMaqInst`, `_08_datBaixaMaqInst`) VALUES (8, 30, 103, 0, 2000, 2000, '2014-06-16 10:10:11', NULL, NULL);
INSERT INTO `u555588791_pinba`.`maqInstall` (`_00_pk_idMaqInst_auto`, `_01_pk_idMaqInst`, `_02_pk_idJocInst`, `_03_numPartidesJugadesMaqInst`, `_04_credJocMaqInst`, `_05_totCredJocMaqInst`, `_06_datAltaMaqInst`, `_07_datModMaqInst`, `_08_datBaixaMaqInst`) VALUES (9, 40, 100, 1, 200, 1000, '2014-06-16 10:10:11', NULL, NULL);
INSERT INTO `u555588791_pinba`.`maqInstall` (`_00_pk_idMaqInst_auto`, `_01_pk_idMaqInst`, `_02_pk_idJocInst`, `_03_numPartidesJugadesMaqInst`, `_04_credJocMaqInst`, `_05_totCredJocMaqInst`, `_06_datAltaMaqInst`, `_07_datModMaqInst`, `_08_datBaixaMaqInst`) VALUES (10, 40, 101, 4, 300, 400, '2014-06-16 10:10:11', NULL, NULL);
INSERT INTO `u555588791_pinba`.`maqInstall` (`_00_pk_idMaqInst_auto`, `_01_pk_idMaqInst`, `_02_pk_idJocInst`, `_03_numPartidesJugadesMaqInst`, `_04_credJocMaqInst`, `_05_totCredJocMaqInst`, `_06_datAltaMaqInst`, `_07_datModMaqInst`, `_08_datBaixaMaqInst`) VALUES (11, 40, 102, 0, 400, 2000, '2014-06-16 10:10:11', NULL, NULL);
INSERT INTO `u555588791_pinba`.`maqInstall` (`_00_pk_idMaqInst_auto`, `_01_pk_idMaqInst`, `_02_pk_idJocInst`, `_03_numPartidesJugadesMaqInst`, `_04_credJocMaqInst`, `_05_totCredJocMaqInst`, `_06_datAltaMaqInst`, `_07_datModMaqInst`, `_08_datBaixaMaqInst`) VALUES (12, 40, 103, 0, 500, 600, '2014-06-16 10:10:11', NULL, NULL);
INSERT INTO `u555588791_pinba`.`maqInstall` (`_00_pk_idMaqInst_auto`, `_01_pk_idMaqInst`, `_02_pk_idJocInst`, `_03_numPartidesJugadesMaqInst`, `_04_credJocMaqInst`, `_05_totCredJocMaqInst`, `_06_datAltaMaqInst`, `_07_datModMaqInst`, `_08_datBaixaMaqInst`) VALUES (13, 40, 104, 0, 600, 1400, '2014-06-16 10:10:11', NULL, NULL);
INSERT INTO `u555588791_pinba`.`maqInstall` (`_00_pk_idMaqInst_auto`, `_01_pk_idMaqInst`, `_02_pk_idJocInst`, `_03_numPartidesJugadesMaqInst`, `_04_credJocMaqInst`, `_05_totCredJocMaqInst`, `_06_datAltaMaqInst`, `_07_datModMaqInst`, `_08_datBaixaMaqInst`) VALUES (14, 50, 103, 0, 2000, 1200, '2014-06-16 10:10:11', NULL, NULL);
INSERT INTO `u555588791_pinba`.`maqInstall` (`_00_pk_idMaqInst_auto`, `_01_pk_idMaqInst`, `_02_pk_idJocInst`, `_03_numPartidesJugadesMaqInst`, `_04_credJocMaqInst`, `_05_totCredJocMaqInst`, `_06_datAltaMaqInst`, `_07_datModMaqInst`, `_08_datBaixaMaqInst`) VALUES (15, 50, 104, 0, 1000, 2000, '2014-06-16 10:10:11', NULL, NULL);
...
START TRANSACTION;
USE `u555588791_pinba`;
INSERT INTO `u555588791_pinba`.`ubicacioTeMaquina` (`_00_pk_idUTM_auto`, `_01_pk_idUbicUTM`, `_02_pk_idMaqUTM`, `_03_datAltaUTM`, `_04_datModUTM`, `_05_datBaixaUTM`) VALUES (1, 1, 10, '2014-06-16 10:10:11', NULL, NULL);
INSERT INTO `u555588791_pinba`.`ubicacioTeMaquina` (`_00_pk_idUTM_auto`, `_01_pk_idUbicUTM`, `_02_pk_idMaqUTM`, `_03_datAltaUTM`, `_04_datModUTM`, `_05_datBaixaUTM`) VALUES (2, 2, 20, '2014-06-16 10:10:11', NULL, NULL);
INSERT INTO `u555588791_pinba`.`ubicacioTeMaquina` (`_00_pk_idUTM_auto`, `_01_pk_idUbicUTM`, `_02_pk_idMaqUTM`, `_03_datAltaUTM`, `_04_datModUTM`, `_05_datBaixaUTM`) VALUES (3, 3, 30, '2014-06-16 10:10:11', NULL, NULL);
INSERT INTO `u555588791_pinba`.`ubicacioTeMaquina` (`_00_pk_idUTM_auto`, `_01_pk_idUbicUTM`, `_02_pk_idMaqUTM`, `_03_datAltaUTM`, `_04_datModUTM`, `_05_datBaixaUTM`) VALUES (4, 4, 40, '2014-06-16 10:10:11', NULL, NULL);
INSERT INTO `u555588791_pinba`.`ubicacioTeMaquina` (`_00_pk_idUTM_auto`, `_01_pk_idUbicUTM`, `_02_pk_idMaqUTM`, `_03_datAltaUTM`, `_04_datModUTM`, `_05_datBaixaUTM`) VALUES (5, 5, 50, '2014-06-16 10:10:11', NULL, NULL);

COMMIT;


-- -----------------------------------------------------
-- Data for table `u555588791_pinba`.`configuracio`
-- -----------------------------------------------------
START TRANSACTION;
USE `u555588791_pinba`;
INSERT INTO `u555588791_pinba`.`configuracio` (`_01_pk_idConfig`, `_02_nomServerMYSQL`, `_03_usrMYSQL`, `_04_passwordUsrMYSQL`, `_05_dbLocalOrRemot`, `_06_emailDebug`, `_07_emailSMTPHost`, `_08_emailSMTPHostPort`, `_09_emailUser`, `_10_emailPassword`, `_11_emailFrom`, `_12_emailNomFrom`, `_13_emailNomToContacte`, `_14_emailCanal`, `_15_emailPathRegistre`, `_16_pathUploads`, `_17_sizeUploads`, `_18_datModConfig`) VALUES (1, 'localhost', 'root', NULL, 'on', 0, 'smtp.gmail.com', '587', 'activar.cuenta.usuario@gmail.com', 'sudoku06', 'activar.cuenta.usuario@gmail.com', 'Pinball', 'Contacte Pinball', 0, 'registre/', 'uploads/', 2000000, NULL);
