...
CREATE  TABLE IF NOT EXISTS `u555588791_pinba`.`joc` (
  ...
  `_04_numPartidesJugadesJoc` INT NULL ,
  `_05_datAltaJoc` DATETIME NULL ,
  `_06_datModJoc` DATETIME NULL ,
  `_07_datBaixaJoc` DATETIME NULL ,
...
INSERT INTO `productes` (`id`, `nom`, `descripcio`, `preu`, `foto`, `datAltPro`, `datModPro`, `datBaixaPro`) VALUES
...
INSERT INTO `productes` (`id`, `nom`, `descripcio`, `preu`, `foto`, `datAltPro`, `datModPro`, `datBaixaPro`) VALUES
(3, 'ROULETTE', 'Rouleta electrónica', 235, 'roulette.jpg', '2014-05-16', NULL, NULL);
INSERT INTO `productes` (`id`, `nom`, `descripcio`, `preu`, `foto`, `datAltPro`, `datModPro`, `datBaixaPro`) VALUES
...
INSERT INTO `productes` (`id`, `nom`, `descripcio`, `preu`, `foto`, `datAltPro`, `datModPro`, `datBaixaPro`) VALUES
(5, 'STANDARD GAMES', 'games descr.', 235, 'standar_games.jpg', '2014-05-16', NULL, NULL);
